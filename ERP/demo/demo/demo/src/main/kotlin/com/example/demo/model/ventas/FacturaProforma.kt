...
@Entity
@Table(name = "ventas_facturas_proforma")
data class FacturaProforma(
    @Id
    ...
    @OneToMany(mappedBy = "facturaProforma", cascade = [CascadeType.ALL], orphanRemoval = true, fetch = FetchType.EAGER)
    @JsonManagedReference
    val lineas: MutableList<FacturaProformaLinea> = mutableListOf(),
