...
data class FacturaRectificativaRequest(
    val fecha: LocalDate = LocalDate.now(),
    val clienteId: Long? = null,
    val facturaOrigenId: Long? = null,
    ...
    val lineas: List<FacturaRectificativaLineaRequest> = emptyList(),
...
data class FacturaRectificativaLineaRequest(
