...
class FacturaPdfService(
    ...
    fun generarPdf(factura: Factura, plantillaId: Long? = null): ByteArray {
        ...
        when (plantilla.layoutEmpresaCliente) {
            "horizontal" -> agregarEmpresaClienteHorizontal(document, factura, plantilla, colorPrimario, tamanoBase)
            "vertical" -> agregarEmpresaClienteVertical(document, factura, plantilla, colorPrimario, tamanoBase)
            "empresa_arriba" -> agregarEmpresaArriba(document, factura, plantilla, colorPrimario, tamanoBase)
            "cliente_arriba" -> agregarClienteArriba(document, factura, plantilla, colorPrimario, tamanoBase)
            else -> agregarEmpresaClienteVertical(document, factura, plantilla, colorPrimario, tamanoBase)
        }
        ...
        // Tabla de productos
        agregarTablaProductos(document, factura, plantilla, colorPrimario, tamanoBase)

        // Totales
        agregarTotales(document, factura, colorPrimario, tamanoBase)

        // Observaciones
        if (plantilla.mostrarObservaciones && factura.observaciones.isNotBlank()) {
            agregarObservaciones(document, factura.observaciones, colorPrimario, tamanoBase)
        }
    ...
    private fun agregarEmpresaClienteHorizontal(
        ...
        if (plantilla.mostrarCliente) {
            table.addCell(
                Cell().add(crearParrafoCliente(factura, plantilla, colorPrimario, tamanoBase))
                    .setBorder(null)
                    .setPadding(10f)
                    .setBackgroundColor(DeviceRgb(248, 250, 252))
            )
        ...
        if (plantilla.mostrarDatosAlbaran) {
            table.addCell(
                Cell().add(crearParrafoFactura(factura, plantilla, colorPrimario, tamanoBase))
                    .setBorder(null)
                    .setPadding(10f)
                    .setBackgroundColor(DeviceRgb(248, 250, 252))
            )
    ...
    private fun agregarClienteArriba(
        ...
        if (plantilla.mostrarCliente) {
            table.addCell(
                Cell(1, 2).add(crearParrafoCliente(factura, plantilla, colorPrimario, tamanoBase))
                    .setBorder(null)
                    .setPadding(10f)
                    .setBackgroundColor(DeviceRgb(248, 250, 252))
            )
    ...
    private fun agregarEmpresaClienteVertical(
        ...
        if (plantilla.mostrarCliente) {
            agregarDatosCliente(document, factura, plantilla, colorPrimario, tamanoBase, true)
        }
        if (plantilla.mostrarDatosAlbaran) {
            agregarDatosFactura(document, factura, plantilla, colorPrimario, tamanoBase, true)
        }
    }
    ...
    private fun agregarDatosFactura(
        document: Document,
        factura: Factura,
        plantilla: PlantillaPdf,
        colorPrimario: DeviceRgb,
    ...
    private fun crearParrafoFactura(
        factura: Factura,
        plantilla: PlantillaPdf,
        colorPrimario: DeviceRgb,
        tamanoBase: Float
        ...
        // Título en su propia línea
        parrafo.add(com.itextpdf.layout.element.Text("DATOS DE LA FACTURA\n")
            .setBold()
            .setFontSize(12f * tamanoBase)
            .setFontColor(colorPrimario))
        
        return parrafo
            .add(Paragraph("Número: ${factura.numero}").setBold().setFontSize(11f * tamanoBase))
            .add(Paragraph("Fecha: ${factura.fecha.format(DateTimeFormatter.ofPattern("dd/MM/yyyy"))}").setFontSize(10f * tamanoBase))
            .add(Paragraph("Estado: ${factura.estado}").setFontSize(10f * tamanoBase))
    }
    ...
    private fun agregarTotales(
        ...
        totalesTable.addCell(
            Cell().add(Paragraph(String.format("%.2f €", factura.subtotal)).setTextAlignment(TextAlignment.RIGHT).setFontSize(11f * tamanoBase))
                .setBorder(null)
                .setPadding(5f)
        )
        ...
        totalesTable.addCell(
            Cell().add(Paragraph(String.format("-%.2f €", factura.descuentoTotal)).setTextAlignment(TextAlignment.RIGHT).setFontSize(11f * tamanoBase).setFontColor(ColorConstants.RED))
                .setBorder(null)
                .setPadding(5f)
        )
        ...
        totalesTable.addCell(
            Cell().add(Paragraph(String.format("%.2f €", factura.total)).setTextAlignment(TextAlignment.RIGHT).setBold().setFontSize(13f * tamanoBase).setFontColor(colorPrimario))
                .setBorder(null)
                .setPadding(5f)
                .setBackgroundColor(DeviceRgb(248, 250, 252))
        )
