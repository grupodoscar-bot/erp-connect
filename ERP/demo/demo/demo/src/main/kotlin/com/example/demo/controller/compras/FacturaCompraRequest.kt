...
data class FacturaCompraRequest(
    val id: Long? = null,
    val numero: String? = null,
    val fecha: String? = null,
    val proveedorId: Long? = null,
    val pedidoCompraId: Long? = null,
    val albaranCompraId: Long? = null,
    val direccionId: Long? = null,
    val observaciones: String? = null,
    val notas: String? = null,
    val estado: String = "Pendiente",
    val lineas: List<FacturaCompraLineaRequest> = emptyList(),
...
data class FacturaCompraLineaRequest(
