...
@Entity
@Table(name = "compras_presupuestos")
data class PresupuestoCompra(
    @Id
    ...
    @OneToMany(mappedBy = "presupuestoCompra", cascade = [CascadeType.ALL], orphanRemoval = true, fetch = FetchType.LAZY)
    @JsonManagedReference
    val lineas: MutableList<PresupuestoCompraLinea> = mutableListOf(),
