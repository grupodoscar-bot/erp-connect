    ...
    try {
      ...
      switch (tipoTransformacionSeleccionado) {
        case 'FACTURA': {
          ...
          const res = await fetch(`${API_ENDPOINTS.facturas}/desde-albaran`, {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify(payload)
          });
        ...
        case 'FACTURA_PROFORMA': {
          ...
          const res = await fetch(`${API_ENDPOINTS.facturasProforma}/desde-albaran`, {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify(payload)
          });
        ...
        case 'FACTURA_RECTIFICATIVA': {
          ...
          const res = await fetch(`${API_ENDPOINTS.facturasRectificativas}/desde-albaran`, {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify(payload)
          });
        ...
        case 'PEDIDO': {
          ...
          const res = await fetch(`${API_ENDPOINTS.pedidos}/desde-albaran`, {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify(payload)
          });
        ...
        case 'PRESUPUESTO': {
          ...
          const res = await fetch(`${API_ENDPOINTS.presupuestos}/desde-albaran`, {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify(payload)
          });
